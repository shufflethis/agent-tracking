...
const en = {
  ...
  agents: {
    ...
    logFed: (date: string) =>
      `Log observations have been received since ${date}. Confirmed fetches require a fresh published IP list and a matching source address. Missing or stale lists and mismatches remain claims. A burst groups nearby requests; it does not reveal a query.`,
...
const de: DashCopy = {
  ...
  agents: {
    ...
    logFed: (date) =>
      `Seit ${date} liegen Log-Beobachtungen vor. Bestätigte Abrufe benötigen eine frische veröffentlichte IP-Liste und eine passende Quelladresse. Fehlende/veraltete Listen und Abweichungen bleiben Behauptungen. Ein Burst bündelt zeitnahe Anfragen; er verrät keine Suchfrage.`,
