...
const en = {
  ...
  overview: {
    ...
    scanScheduled: "Automatic scan scheduled within 24 hours of verification.",
    scanPending: "The automatic scan is pending.",
...
const de: DashCopy = {
  ...
  overview: {
    ...
    scanScheduled: "Automatischer Scan innerhalb von 24 Stunden nach der Verifizierung geplant.",
    scanPending: "Der automatische Scan steht noch aus.",
