...
describe("site readers and private findings", () => {
  ...
  it("tracks evidence, correction and genuine retest without crossing sites", () => {
    ...
    const basic = { findingId, taskRunId: beforeId, evidenceRefs: [`run:${beforeId}`], category: "form_discovery", description: "Success marker absent", assignee: "owner@example.com", status: "open" };
